...
class AgenticMaritimeVesselTrackerSession(Base):
    __tablename__ = "maritime_vessel_tracker_sessions"
...
class AgenticMaritimeVesselTrackerItem(Base):
    __tablename__ = "maritime_vessel_tracker_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("maritime_vessel_tracker_sessions.id"))
